...
# @@Created          :  Saturday, Jul 15, 2023 19:19 EDT
# @@File             :  autostart.sh
# @@Description      :
...
if [ -f "/usr/lib/xfce-polkit/xfce-polkit" ]; then
  __silent_kill xfce-polkit
  __silent_start "/usr/lib/xfce-polkit/xfce-polkit"
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# mpd
if { [ -z "$MPDSERVER" ] || [ "$MPDSERVER" = "localhost" ] || [ "$MPDSERVER" = "$(hostname -f)" ] || [ "$MPDSERVER" = "$(hostname -s)" ]; } && __does_cmd_exist mpd && __is_stopped mpd; then
  __silent_kill mpd
  __silent_start mpd
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
if __does_cmd_exist ksuperkey; then
  __silent_kill ksuperkey
  __silent_start ksuperkey -e 'Super_L=Alt_L|F1'
  __silent_start ksuperkey -e 'Super_R=Alt_L|F1'
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Fix cursor
if __does_cmd_exist xsetroot; then
  __silent_kill xsetroot
  __silent_start xsetroot -cursor_name left_ptr
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
